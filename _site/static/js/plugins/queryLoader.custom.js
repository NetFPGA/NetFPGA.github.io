...
(function($) {
    ...
    var qLoverlay = "";
    var qLbar = "#pre-loader .progress-bar > .line";
    var qLpercentage = "#pre-loader .progress-bar > .perc";
    ...
    var qLoptions = {
        ...
        percentage: true,
        deepSearch: true,
        onLoadComplete: function () { qLoptions.onComplete() }
    };
    ...
    $.fn.preloaderJQ = function(options) {
        if(options) {
